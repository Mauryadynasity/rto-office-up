...
<div class="content-wrapper pt-2">
    ...
    <div class="container-fluid">
        ...
        <div class="flash-message">
            ...
            <div class="row"> 
                <div class="col-md-12"> 
                    <h1 class="subheading pb-3">Edit Static Content</h1>
                </div>
            ...
            <div class="row form-row add-content">
                <div class="col-md-12"> 
                <form role="form" autocomplete="off" action="{{url('admin/static-contents/'.$content->id)}}" enctype="multipart/form-data" method="post">
                    @method('PUT')
                    {{ csrf_field() }}  
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-10">
                            ...
                            <option @if(old('section',@$content->page_variable) == 'review') selected @endif  value="review">Reviews</option>
                            <option @if(old('section',@$content->page_variable) == 'our product') selected @endif  value="our product">Our Product</option>
                            <option @if(old('section',@$content->page_variable) == 'our clients') selected @endif  value="our clients">Our clients</option>
                            <option @if(old('section',@$content->page_variable) == 'privacy policy') selected @endif  value="privacy policy">Privacy Policy</option>
                          </select>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="title" class="form-control" placeholder="Enter Title" maxlength="30" value="{{ $content->page }}">
                          @if ($errors->has('title'))
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-10">
                            <textarea  name="content" class="form-control" maxlength="3000" placeholder="Enter Content">{{ old('content') ? old('content') : $content->content}}</textarea>
                ...
                <div class="form-row form-group">
                    ...
                    <div class="uploaded-img">
                        <img src="{{url('public/uploads/image/'.$content->image) }}" class='profile-img-tag' onerror="this.src='{{url('public/front/img/doc.png') }}';" width="100" height="100" >
                    </div>
                     @if ($errors->has('image'))
                  ...
                  <div class="form-row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="type" class="form-control" placeholder="Enter type" maxlength="30" value="{{ $content->type }}">
                          @if ($errors->has('type'))
...
$(document).on('change','input[type=file]',function(){
    ...
    var allowedTypes = ['png','jpeg','jpg','xls','xlsx','doc','docx','pdf'];
